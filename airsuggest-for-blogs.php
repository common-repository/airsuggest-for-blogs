 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Airsuggest For Blogs
 ...
 * Text Domain:       airsuggest-for-blogs
...
function activate_airsuggest_for_blogs() {
    
}

function deactivate_airsuggest_for_blogs() {
...
register_activation_hook(__FILE__, 'activate_airsuggest_for_blogs');
register_deactivation_hook(__FILE__, 'deactivate_airsuggest_for_blogs');

function airsuggest_add_menu() {
    add_submenu_page("options-general.php", "Airsuggest API Key", "Airsuggest API Key", "manage_options", "airsuggest-store-settings", "airsuggest_for_blogs_page");
}

add_action("admin_menu", "airsuggest_add_menu");

function airsuggest_for_blogs_page() {
    ?>
    <div class="wrap">
        <h1>Airsuggest API Key</h1>
        <form method="post" action="options.php">
            <?php
            settings_fields("airsuggest_for_blogs_api_key");
...
function airsuggest_for_blogs_settings() {
    add_settings_section("airsuggest_for_blogs_api_key", "", null, "airsuggest-setting-section");
    add_settings_field("airsuggest_store_api_key", "", "airsuggest_for_blogs_options", "airsuggest-setting-section", "airsuggest_for_blogs_api_key");
    register_setting("airsuggest_for_blogs_api_key", "airsuggest_store_api_key");
}

add_action("admin_init", "airsuggest_for_blogs_settings");

function airsuggest_for_blogs_options() {
    ?>
